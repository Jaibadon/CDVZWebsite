...
$sql2 = "SELECT *, (Rate * Hours) AS amt FROM Timesheets LEFT OUTER JOIN Staff ON Timesheets.Employee_id = Staff.Employee_ID WHERE Invoice_No = ? ORDER BY Timesheets.TS_DATE";
